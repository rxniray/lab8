...
$carcompanys = $_POST['carcompanys'];
$idcarcompany = $_POST['idcarcompany']; 
$idplant = $_POST['idplant']; 
$iddealer = $_POST['iddealer'];


$sql = "UPDATE car_companys SET name_car_company='$carcompanys', id_plant='$idplant' , id_dealer ='$iddealer' WHERE idcar_company='$idcarcompany'";
